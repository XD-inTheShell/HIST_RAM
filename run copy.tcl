...
puts "Writing to all the RegFile elements..."
fill_memory $claim_path_0 $regfile_base $regfile_length
puts "Write Complete! Beginning read back..."
verify_memory $claim_path_0 $regfile_base $regfile_length
# master_write_32 $claim_path $base 0x4d4d4d4d
